...
if ((isset($_POST['enviar']))){
    ...
    $controlador->editar($_POST['idu'],$_POST['firstname'],$_POST['lastname'],$_POST['image']);
...
<div class="container text-center">
  ...
  <div class="col-12 title">
    <h2><b>Actualizar datos del usuario</b></h2>
  </div>
  </div>
...
<div class="card mb-3" style="margin:0 auto;">
  <div class="row g-0">
    <div class="col-md-4">
      ...
      <?php
      if (!empty($row['image'])){
							echo '<td><img src="imgs/'.$row['image'].'"  class="img-fluid rounded-start" alt="..."></td>';
                 		   }else
						   {
							echo '<td><img src="imgs/noimage.png" class="img-fluid rounded-start" alt="..."></td>';
...
-->
        ...
        <div style="margin-top:5px;">
              ...
              <div class="col-sm-10">
                  <input type="text"  name="idu" class="form-control" id="idu" value="<?php echo $row['id']; ?>" placeholder="Su id aqui">
                </div>
              </div>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text"  name="firstname" class="form-control" id="firstname" value="<?php echo $row['firstname']; ?>" placeholder="Su Nombre aqui">
                </div>
              </div>
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="lastname" id="lastname" value="<?php echo $row['lastname']; ?>" placeholder="Su apellido aqui">
                  </div>
                </div>
  ...
  <div class="col-sm-10">
      <input type="text" class="form-control" id="staticEmail" name="email" value="<?php echo $row['email']; ?>" placeholder="Su email aqui">
    </div>
  </div>
  ...
  <input type="text" class="form-control" id="image" name="image" value="<?php echo $row['image']; ?>" placeholder="Su imagen aqui">
